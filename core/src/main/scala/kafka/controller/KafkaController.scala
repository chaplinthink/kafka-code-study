...
class ControllerContext(val zkUtils: ZkUtils,
  ...
  var partitionLeadershipInfo: mutable.Map[TopicAndPartition, LeaderIsrAndControllerEpoch] = mutable.Map.empty //记录了每个分区的leader 副本所在的brokerId、ISR集合以及controller_epoch
