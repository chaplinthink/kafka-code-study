...
public final class RecordAccumulator {
    ...
    private final int batchSize; //指定每个RecordBatch底层ByteBuffer的大小
    private final CompressionType compression; //压缩类型
    private final long lingerMs;
    private final long retryBackoffMs;
    private final BufferPool free;
    private final Time time;
    private final ConcurrentMap<TopicPartition, Deque<RecordBatch>> batches; //缓存了发往对应TopicPartition的消息
    ...
    public RecordAccumulator(int batchSize,
        ...
        this.batches = new CopyOnWriteMap<TopicPartition, Deque<RecordBatch>>(); //线程安全的集合。 Deque是非线程安全的集合，追加消息或发送RecordBatch的时候，需要加锁同步。 每个Deque都保存了发往对应TopicPartition的RecordBatch集合
    ...
    public RecordAppendResult append(TopicPartition tp,
        ...
        try {
            ...
            synchronized (dq) {
                ...
                RecordBatch batch = new RecordBatch(tp, records, time.milliseconds());  //一条消息对应一个RecordBatch
